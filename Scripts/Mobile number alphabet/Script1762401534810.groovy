...
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/field_mobileNumber'), 'abcdefg')
...
WebUI.callTestCase(findTestCase('take screenshot'), [:], FailureHandling.STOP_ON_FAILURE)
